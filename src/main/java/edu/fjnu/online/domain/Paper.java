...
public class Paper {
	...
	public int getSingleSelectNum() { return singleSelectNum; }
	public void setSingleSelectNum(int singleSelectNum)
    {
        this.singleSelectNum = singleSelectNum;
    }
    public int getMultiSelectNum() { return multiSelectNum;}
